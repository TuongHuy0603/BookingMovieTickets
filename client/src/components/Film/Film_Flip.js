...
export default function Film_Flip(props) {
    ...
    return (
        <div className="flip-card mt-2">
            ...
            }} className="rounded-sm bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-center cursor-pointer py-2 bg-indigo-300 my-2 text-success-50 font-bold">ĐẶT VÉ</div>
        </div>
